  ...
  methods: {
    ...
    async loadFeatureLayer() {
      this.fishmapLayer = new FeatureLayer({
        url: "http://localhost:6080/arcgis/rest/services/shanghai/hotspot_yangpu/MapServer/0",
        opacity: 0.6,
        // popupTemplate,
      });

      this.hotAreaLayer = new FeatureLayer({
        url: "http://localhost:6080/arcgis/rest/services/shanghai/hotspot_yangpu/MapServer/1",
        opacity: 0.6,
      });
